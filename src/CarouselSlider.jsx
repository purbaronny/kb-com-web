        ...
        <section id="home">
          <Carousel controls={false} pause={false} fade={true}>
            <Carousel.Item interval={3000}>
              <img id="carousel" className="d-block w-100" src="./Pictures/content07.png" alt="First slide" />
              <Carousel.Caption>
                ...
                <Link to="service#companyMaintenance" className="btn btn-warning searched">
                  {this.state.button}
                  <Arrow />
                </Link>
              </Carousel.Caption>
            ...
            <Carousel.Item interval={3000}>
              <img id="carousel" className="d-block w-100" src="./Pictures/meeting4.png" alt="Second slide" />
              <Carousel.Caption>
                <h4 className="caption">
                  {this.state.caption3}
                  <br></br>
                ...
                <Link to="visionAndMission#businessDomain" className="btn btn-warning searched">
                  {this.state.button}
                  <Arrow />
                </Link>
              </Carousel.Caption>
            ...
            <Carousel.Item interval={3000}>
              <img id="carousel" className="d-block w-100" src="./Pictures/typing.png" alt="Third slide" />
              <Carousel.Caption>
                <h4 className="caption">
                  {this.state.caption5}
                  <br></br>
                ...
                <Link to="service#companyOperation" className="btn btn-warning searched">
                  {this.state.button}
                  <Arrow />
                </Link>
              </Carousel.Caption>
