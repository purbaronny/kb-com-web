          ...
          <div className="row">
            <div className="col-10 mx-auto">
              <nav className="navbar navbar-expand-lg">
                <NavLink className="navbar-brand" to="/">KB Data Systems Indonesia</NavLink>
                ...
                <div className="collapse navbar-collapse" id="navbarSupportedContent">
                  <ul className="navbar-nav ml-auto mb-2 mb-lg-0">
                    <li className="nav-item">
                      <Dropdown>
                        <Dropdown.Toggle variant="success" id="dropdown-basicAbout" className='background-white'>{this.state.titleAbout}</Dropdown.Toggle>
                    ...
                    <li className="nav-item">
                      <Dropdown>
                        <Dropdown.Toggle variant="successSolution" id="dropdown-basicSolution" className='background-white'>{this.state.titleSolution}</Dropdown.Toggle>
                    ...
                    <li className="nav-item">
                      <NavLink className="nav-link" to="/career">{this.state.titleCareerWithUs}</NavLink>
                    </li>
                    <li className="nav-item">
